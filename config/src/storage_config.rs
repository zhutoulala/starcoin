...
pub struct RocksdbConfig {
    ...
    #[structopt(name = "rocksdb-wal-bytes-per-sync", long, help = "rocksdb wal bytes per sync")]
...
impl StorageConfig {
    ...
    pub fn rocksdb_config(&self) -> RocksdbConfig {
        ...
        RocksdbConfig {
            ...
            wal_bytes_per_sync: self.wal_bytes_per_sync.unwrap_or(default.wal_bytes_per_sync),
        }
    }
